...
/**
 * Base de contenedor de configuracion
 *
...
abstract class ConfigurationWrapper 
{
     ...
     * @return \Tecnocreaciones\Bundle\ToolsBundle\Model\Configuration\ConfigurationService
     */
    ...
    {
        $this->getConfigurationService()->set($key, $value, $description,$group,$this->getId());
    ...
    {
        return $this->getConfigurationService()->get($key, $default);
    }
    ...
    {
        $this->getConfigurationService()->flush();
    }
